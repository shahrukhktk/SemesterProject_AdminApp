...
public class DatesheetsSection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Exams Datesheets").child("Event");
        dbReference = FirebaseDatabase.getInstance().getReference("Exams Datesheets").child("Event");
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(DatesheetsSection.this, "Upload Successful", Toast.LENGTH_SHORT).show();
    ...
    public void uploadImageButton(View view)
    {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(DatesheetsSection.this);
        ...
        builder.setItems(selection, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                ...
                if(selection[position].equals("Gallery"))
                {
                    ...
                    Toast.makeText(DatesheetsSection.this, "Image is ready to post", Toast.LENGTH_SHORT).show();
                }
    ...
    {
        startActivity(new Intent(DatesheetsSection.this, RetrieveData_Datesheet.class));
    }
