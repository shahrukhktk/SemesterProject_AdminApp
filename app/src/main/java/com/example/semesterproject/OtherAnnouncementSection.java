...
public class OtherAnnouncementSection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("OTHER ANNOUNCEMENTS");
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(OtherAnnouncementSection.this, "Upload Successful", Toast.LENGTH_SHORT).show();
    ...
    public void RecyclerViewData(View view)
    {
        startActivity(new Intent(OtherAnnouncementSection.this, RetrieveData_Announcements.class));
    }
    ...
    public void uploadImageButton(View view)
    {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(OtherAnnouncementSection.this);
        ...
        builder.setItems(selection, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                ...
                if(selection[position].equals("Gallery"))
                {
                    ...
                    Toast.makeText(OtherAnnouncementSection.this, "Image is ready to post", Toast.LENGTH_SHORT).show();
                }
