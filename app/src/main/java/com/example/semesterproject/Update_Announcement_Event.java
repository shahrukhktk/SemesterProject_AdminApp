...
public class Update_Announcement_Event extends AppCompatActivity
{
    ...
    //variable will be used for update
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_update__announcement__event);

        Toolbar toolbar = findViewById(R.id.toolbarsemester);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("UPDATE - ANNOUNCEMENT EVENT");

        //Get Reference to DATABASE
        storageReference = FirebaseStorage.getInstance().getReference("Announcements").child("Event");
        dbReference = FirebaseDatabase.getInstance().getReference("Announcements").child("Event");

        eventMessageEditText = (EditText) findViewById(R.id.update_messagebox_field);
        imageView = (ImageView) findViewById(R.id.image_selected);
        mProgressBar = (ProgressBar) findViewById(R.id.progressbar);

        eventMessageEditText.setText(message);
        eventMessageEditText.setSelection(message.length());
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Update_Announcement_Event.this, "UPDATE SUCCESSFULL", Toast.LENGTH_SHORT).show();
    ...
    public void GetImage(View view)
    {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(Update_Announcement_Event.this);
        ...
        builder.setItems(selection, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                ...
                if(selection[position].equals("Gallery"))
                {
                    ...
                    Toast.makeText(Update_Announcement_Event.this, "Image is ready to post", Toast.LENGTH_SHORT).show();
                }
