...
public class Announcment_Adapter extends RecyclerView.Adapter<Announcment_Adapter.customViewHolderadapter>
{
    private Context mContext;
    private List<UploadEvent> list;

    public Announcment_Adapter(Context mContext, List<UploadEvent> list) {
        this.mContext = mContext;
        this.list = list;
    }

    @Override
    public customViewHolderadapter onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    private void inflateMenu(Announcment_Adapter.customViewHolderadapter obj, final int position) {
